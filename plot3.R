# Code for Plot 3 of Project 1 from Experimental Data Analysis
...
drawPlot <- function(){
    par(mfrow=c(1,1))
    with(kcz_crs04_prj1_temp_dt,plot(DT,Sub_metering_1,ylab="Energy sub metering",type="n"))
    with(kcz_crs04_prj1_temp_dt,lines(DT,Sub_metering_1,col="black"))
    with(kcz_crs04_prj1_temp_dt,lines(DT,Sub_metering_2,col="red"))
    with(kcz_crs04_prj1_temp_dt,lines(DT,Sub_metering_3,col="blue"))
