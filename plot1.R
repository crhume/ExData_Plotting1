# Code for Plot 1 of Project 1 from Experimental Data Analysis
...
drawPlot <- function(){
    par(mfrow=c(1,1))
    hist(kcz_crs04_prj1_temp_dt$Global_active_power,col="Red",xlab="Global Active Power (kilowatts)",main="Global Active Power")
}
